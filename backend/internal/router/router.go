...
func Setup(
	...
	{
		dispatch.GET("/orders", dispatchHandler.ListOrders)
		dispatch.POST("/orders", dispatchHandler.CreateOrder)
		dispatch.POST("/orders/:id/cancel", dispatchHandler.CancelOrder)
	}
